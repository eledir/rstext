...
public class Indexing {
	...
	public  void setTRECIndexing(String _path, String _prefix)
	{
		...
		String indexerName = MyApplicationSetup.getProperty(
			"trec.indexer.class",
			MyApplicationSetup.BLOCK_INDEXING
				? "BlockIndexer"
				: "BasicIndexer");
	...
	public void createSinglePass(){
		...
		if (MyApplicationSetup.BLOCK_INDEXING)
			_indexer = new BlockSinglePassIndexer(MyApplicationSetup.TERRIER_INDEX_PATH, MyApplicationSetup.TERRIER_INDEX_PREFIX);
		else
			_indexer = new BasicSinglePassIndexer(MyApplicationSetup.TERRIER_INDEX_PATH, MyApplicationSetup.TERRIER_INDEX_PREFIX);
