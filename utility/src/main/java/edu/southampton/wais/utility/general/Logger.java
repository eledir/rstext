...
public class Logger {
     ...
     */
    static {
        logger = java.util.logging.Logger.getLogger("edu.southampton.wais.utility");
    ...
    private static java.util.logging.Level selezionaLivello() {
        String livello = System.getProperty("edu.southampton.wais.utility.LogLevel");
        logger.fine(livello);
        if (livello != null) {
    ...
    private static java.util.logging.Handler selezionaHandler(){
        ...
        String nomeFile = System.getProperty("edu.southampton.wais.utility.LogFile");
