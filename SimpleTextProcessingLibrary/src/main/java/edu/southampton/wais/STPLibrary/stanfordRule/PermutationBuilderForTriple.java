...
public class PermutationBuilderForTriple {
	...
	public static void main(String[] args) {
		...
		map.putAll(0, Lists.newArrayList(1, 3, 4));
		map.putAll(1, Lists.newArrayList(6,7));
		map.putAll(2, Lists.newArrayList(1, 4));
	...
	public static List<RuleIstance>build(Multimap<Integer, Integer> map){
